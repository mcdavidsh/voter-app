            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body app-heading fixed-top">
                        <?php
                        $img = mysqli_query($con,"select * from manager where username='".$_SESSION['adlogin']."'");
                   ...
                   ";
                        ...
                        <div class="app-title">
                            ...
                            <div class="row no-padding no-gap no-gutters">
                                <div class="col-md-1">
                                    <div class="description">Admin ID: <?php echo $row['id']; ?></div>
                                </div>
                                <div class="col-md-2">
                                    <div class="description">Account Created on: <?php echo date('M jS, Y', strtotime($row['id'])); ?></div>
                                </div>
                            </div>
