        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="timeline">
                    ...
                    <dl>
                        <div class='content-heading __center pull-right'>
                            <div class='title'>Inactive Elections</div>
                            <div class='description'>These are elections have not started or have ended.</div>
                        </div>
                        <?php
                        $query = mysqli_query($con, "select contestcat.*,contestreg.ctcatid as ctid from contestcat  left join contestreg on contestcat.id = contestreg.ctcatid group  by contestcat.id");
